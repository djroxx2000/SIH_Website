...
//Change title on carousel button
const buttonInfo = (targetIndex) => {
    if (targetIndex === 0) {
        nextButton.title = 'Lawyer Login';
    } else if (targetIndex === 1) {
        nextButton.title = 'Admin Login';
        prevButton.title = 'Client Login';
    } else if (targetIndex === 2) {
        prevButton.title = 'Laywer Login';
    }
}
